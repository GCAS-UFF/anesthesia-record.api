...
namespace UFF.FichaAnestesica.Infra.Context
{
    public class SigaDbCtx : DbContext, ISigaDbCtx
    {
        ...
        public DbSet<AnesthesiaRecordSurgery> AnesthesiaRecordProcedures { get; set; }
        ...
        public DbSet<PreAnesthesiaSurgery> PreAnesthesiaSurgeries { get; set; }
        public DbSet<PreAnesthesiaComorbidity> PreAnesthesiaComorbidities { get; set; }

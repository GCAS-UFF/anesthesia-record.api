...
//    {
//        //_hospitalRepoMock
//        //    .Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        _hospitalRepoMock
//            .Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .Callback<DateTime?, SurgeryStatusEnum?, int, int>((d, _, _, _) => capturedHospitalDate = d)
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto>(), TotalItems = 0 });
...
//        _surgeryRepoMock
//            .Setup(x => x.GetPatientsWithSurgeriesAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        Assert.Equal(SurgeryStatusEnum.Scheduled, surgery.Status);
...
//    {
//        var hospitalData = new List<PatientDto>
//        {
//            new PatientDto { Id = "1", FullName = "Maria", SurgeryId = "1", SurgeryDate = new DateTime(2025, 6, 10), ProcedureId = "P1", ProcedureDescription = "Proc1", IsPrimaryProcedure = true },
//            new PatientDto { Id = "1", FullName = "Maria", SurgeryId = "1", SurgeryDate = new DateTime(2025, 6, 10), ProcedureId = "P2", ProcedureDescription = "Proc2", IsPrimaryProcedure = false },
//            new PatientDto { Id = "1", FullName = "Maria", SurgeryId = "2", SurgeryDate = new DateTime(2025, 6, 11), ProcedureId = "P3", ProcedureDescription = "Proc3" }
//        };

//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = hospitalData, TotalItems = 3 });

//        List<Patient>? capturedPatients = null;
//        _surgeryRepoMock.Setup(x => x.AddOrUpdatePatientsAsync(It.IsAny<IList<Patient>>()))
//            .Callback<IList<Patient>>(list => capturedPatients = list.ToList())
//            .Returns(Task.CompletedTask);
//        _surgeryRepoMock.Setup(x => x.GetPatientsWithSurgeriesAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto> { new PatientDto { Id = "1" } }, TotalItems = 3 });
...
//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto> { new PatientDto { Id = "1" } }, TotalItems = 2 });
//        _surgeryRepoMock.Setup(x => x.AddOrUpdatePatientsAsync(It.IsAny<List<Patient>>())).Returns(Task.CompletedTask);
//        _surgeryRepoMock.Setup(x => x.GetPatientsWithSurgeriesAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        var hospitalData = new PagedResponse<PatientDto>
//        {
//            Data = new List<PatientDto> { new PatientDto { Id = "1" } },
//            TotalItems = 100
//        };
...
//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto> { new PatientDto { Id = "1" } }, TotalItems = 1 });
//        _surgeryRepoMock.Setup(x => x.AddOrUpdatePatientsAsync(It.IsAny<List<Patient>>())).Returns(Task.CompletedTask);
//        _surgeryRepoMock.Setup(x => x.GetPatientsWithSurgeriesAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto> { new PatientDto { Id = "1" }, new PatientDto { Id = "2" } }, TotalItems = 2 });
//        _surgeryRepoMock.Setup(x => x.AddOrUpdatePatientsAsync(It.IsAny<List<Patient>>())).Returns(Task.CompletedTask);
//        _surgeryRepoMock.Setup(x => x.GetPatientsWithSurgeriesAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
...
//        var surgery = Surgery.Create("1", DateTime.Now, SurgeryStatusEnum.Scheduled, "1", null, null);
...
//        _hospitalRepoMock.Setup(x => x.GetSurgeriesFromHospitalAsync(It.IsAny<DateTime?>(), It.IsAny<SurgeryStatusEnum?>(), It.IsAny<int>(), It.IsAny<int>()))
//            .Callback<DateTime?, SurgeryStatusEnum?, int, int>((d, s, p, sz) => { capturedDate = d; capturedStatus = s; hospPage = p; hospSize = sz; })
//            .ReturnsAsync(new PagedResponse<PatientDto> { Data = new List<PatientDto>(), TotalItems = 0 });

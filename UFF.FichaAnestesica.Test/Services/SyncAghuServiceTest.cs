...
//        var result = await _service.GetPatientAnesthesiaRecordByIdAsync("1");
...
//        var result = await _service.GetPatientAnesthesiaRecordByIdAsync("99");
//        Assert.Null(result);
//    }

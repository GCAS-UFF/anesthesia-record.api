...
{
    public class SurgeriesAppService
    {
        private readonly IHttpClientFactory _httpClientFactory;
        private readonly DbiUffFichaAnestesicaContext _context;

        public SurgeriesAppService(IHttpClientFactory httpClientFactory, DbiUffFichaAnestesicaContext context)
        {
            _httpClientFactory = httpClientFactory;
            _context = context;
        }

        public async Task<List<SurgeryListDto>> SyncAndGetSurgeriesTodayAsync()
        {

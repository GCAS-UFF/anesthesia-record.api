...
public class CompressedAirFlow : Base
{
    ...
    public static CompressedAirFlow Create(CompressedAirFlowCommand command) => new CompressedAirFlow
    {
        Date = command.Date,
        Time = command.Time,
    ...
    public void Update(CompressedAirFlowCommand command)
    {
        Time = command.Time;
        Date = command.Date;
        FlowRateLPerMin = command.FlowRateLPerMin;
